(function () {
  ...
  const en = {
    ...
    section_habits_subtitle: 'What the team actually does differently today because of Tato.',
    section_ai_tasks_title: 'AI Tasks in regular use',
    section_ai_tasks_subtitle: 'How work has changed — tasks where Tato is embedded in recurring execution.',
  ...
  const fr = {
    ...
    section_habits_subtitle: "Ce que l'équipe fait différemment aujourd'hui grâce à Tato.",
    section_ai_tasks_title: 'Tâches IA en usage régulier',
    section_ai_tasks_subtitle: "Comment le travail a changé — tâches où Tato est intégré à l'exécution récurrente.",
    ...
    section_w2v_title: 'Du gaspillage à la valeur',
    ...
    enum: {
      ...
      waste:      { Overhead: 'Surcharge', 'Idle Time': 'Temps mort', Rework: 'Reprise', 'Scope Creep': 'Dérive de périmètre' },
